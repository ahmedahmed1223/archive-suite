...
## سوق الإضافات الآمن — مكتمل ومتحقق منه 2026-07-11

- [x] **كتالوج محلي بلا تنفيذ كود** — أضيف `GET /api/v1/plugins` ككتالوج read-only authenticated يعرض سياسة runtime صريحة: catalog-only، لا تنزيل خارجي، لا تنفيذ كود، ومراجعة مشرف مطلوبة لأي توسعة مستقبلية.
...
- [x] **واجهة `/plugins`** — أضيفت صفحة عربية ضمن النظام تعرض الفلاتر، حالة كل إضافة، المخاطر، وأعلام المراجعة، مع توثيق OpenAPI واختبار Laravel مخصص.
