...
[`v1.4.0`](docs/release-notes/v1.4.0.md) is the current General Availability
release and is covered by the support window in [docs/versioning.md](docs/versioning.md).

Archive Suite v1.4.0 is generally available. The release notes describe the changes,
