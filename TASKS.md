...
- ترتيب التنفيذ: `P1 Setup core → P2 lifecycle → (P3 Windows Native + P4 Linux Native + P6 daily UX + P8 مميزات الإصدار الأول) → P5 parity → P7 RC/GA`.
...
- [ ] **V1-701 (B01)** مؤشر اكتمال التوصيف (🟢🟡🔴) لكل سجل — RecordsController + بطاقة السجل
- [ ] **V1-702 (B02)** حقول شرطية في محرر الأنواع المخصصة (عرض حسب قيمة حقل آخر) — TypesController
- [ ] **V1-703 (B03)** خريطة موحدة لكل السجلات الموقّعة جغرافياً (ترقية من GeotagPanel لسجل واحد)
- [ ] **V1-704 (B04)** ربط استيراد SRT/VTT بحفظ فعلي في حقل التفريغ (حالياً معاينة فقط في media/play)
- [ ] **V1-705 (B11)** القفز من نتيجة البحث مباشرة للحظة الزمنية بالفيديو
- [ ] **V1-706 (B32)** لغة بحث متقدمة بصياغة field:value وعوامل منطقية
- [ ] **V1-707 (B60)** معاينة سريعة (Hover Preview) لنتيجة البحث
- [ ] **V1-708 (B57)** عرض فرق بصري (Diff View) لبيانات RecordHistoryController
...
- [ ] **V1-715 (B10)** تصدير Premiere XML / FCPXML إضافي في lib/montage.ts (بجانب JSON وEDL الموجودين)
...
- [ ] **V1-767 (B39)** مكوّن Skeleton موحّد لحالات التحميل (بدل نص "جار تحميل..." الخام)
...
- [ ] **V1-771 (B46)** استخراج hook useMediaQuery موحّد بدل تكرار matchMedia اليدوي
...
- [ ] **V1-780 (B62)** شريط تقدّم علوي رفيع بين الصفحات
