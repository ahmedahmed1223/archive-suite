...
- [ ] **V2-REL-003 — قرار الإطلاق.** ← **بانتظارك أنت**
  ...
  **وكشفت كتابة الوثيقتين ثلاثة شروط سابقة للإطلاق، لا ملاحظات تشغيلية:**
  1. **النسخ الاحتياطي لا يعمل تلقائيًا.** المجدول يحمل `backup:cleanup` يوميًا
     ولا يحمل `archive:backup-run`. أي أن التنظيف يعمل والإنشاء لا، ويبقى RPO
     **غير محدود** حتى يجدول أحدهم الإنشاء.
  2. **RTO لم يُقَس بعد** على أي بيئة. الخدمة تعلن ذلك صراحةً بدل رقم مُختلق،
     ويكفي تشغيل `backup:dr-drill` مرة واحدة.
  ...
  976/976، والقبول الحي من الإدخال إلى الاعتماد ناجح). القرار — ومعه الثلاثة
  أعلاه — قرارك.
