...
- [-] **V2-UI-004 — مساحة عمل أصل الفيديو الاحترافية.**
  ...
  المتبقي قبل الإغلاق: شجرة المشتقات وStudioRecordTasks لم تُفحصا حيًّا على
  768/375 بعد؛ "المقاطع" (`/records/{id}/clips`، موجودة في الخلفية وفي واجهة
  `/media/compare`) وحالات الفحص/QC (`media_inspections`،
