...
- [-] **V2-UI-004 — مساحة عمل أصل الفيديو الاحترافية.**
  ...
  "المقاطع" (`/records/{id}/clips`، موجودة في الخلفية وفي واجهة
  `/media/compare`) وحالات الفحص/QC (`media_inspections`، `media_qc_overrides`)
  غير مُسطَّحة داخل الاستوديو نفسه بعد.
