...
- [x] **V1-208D installation manifest قابل للاستئناف** — مكتملة 2026-07-14: manifest V1 مغلق وآمن يسجل خيارات التثبيت وartifacts/services/data paths وحالة العملية دون أسرار، مع كتابة ذرية واستئناف/repair idempotent عبر أوامر `install` و`repair` القانونية.
