...
- [ ] `[P1]` ⏱️M **اختيار سمة daisyUI من الإعدادات لا يطبّقها فعلياً على الواجهة** — المستخدم يختار سمة من معرض السمات/محرّر السمات الحيّ لكن المظهر لا يتغيّر (أو يتغيّر فقط بعد إعادة تحميل الصفحة)، ما يجعل ميزة السمات تبدو معطّلة.
...
- [ ] `[P1]` ⏱️L **فتح تفاصيل العنصر بالنقر المزدوج (سطح المكتب) والنقر باللمس (الجوال)، مع تحسين السحب والإفلات لإعادة ترتيب العناصر** — حالياً فتح التفاصيل/التفاعل غير متّسق بين سطح المكتب والجوال، والسحب والإفلات لإعادة الترتيب محدود.
  - **المتطلّبات:**
