...
### UI/UX Follow-up — 2026-06-12

- [x] **UIUX-F11 — توحيد طبقات الأشرطة السفلية على الموبايل**
  - أضف tokens عامة لارتفاع bottom tabs وموضع action/bulk/progress bars.
  - ارفع `MobileActionBar`, `BulkActionBar`, و`ProgressBar` فوق safe-area والتنقل السفلي بدون أرقام متفرقة.
  - التحقق: لا يغطي أي شريط ثابت تبويبات الموبايل أو أزرار الصفحة.

- [x] **UIUX-F12 — منع تزاحم معاينة الأرشيف مع إجراءات الموبايل**
  - اجعل `PreviewPanel` bottom sheet فوق التبويب السفلي فقط، وتعود sticky على desktop.
...
- [x] **UIUX-F14 — إصلاح drawer القائمة على الموبايل**
  - أزل الإغلاق الذاتي للقائمة الجانبية عند `sidebarOpen` على mobile.
  - التحقق: زر القائمة يفتح drawer ويبقى مرئياً حتى يختار المستخدم صفحة أو يغلقه.
