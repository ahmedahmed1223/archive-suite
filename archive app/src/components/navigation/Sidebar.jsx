    ...
    children: [
      ...
      jsx("nav", {
        ...
        children: jsxs(Fragment, {
          children: [
            editing && jsxs("div", {
              className: "sticky top-0 z-10 -mx-1 mb-1 flex items-center gap-1.5 rounded-xl border border-emerald-500/25 bg-emerald-500/[0.06] p-2",
              children: [
      ...
      jsxs("div", {
        ...
        children: [
          ...
          !editing && !collapsed && jsxs("button", {
            ...
            children: [
              jsx(Settings2, { className: "h-4 w-4 shrink-0 text-emerald-300" }),
              "تخصيص القائمة"
            ]
          }),
