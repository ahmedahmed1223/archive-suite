...
describe("pomodoro state machine", () => {
  ...
  it("counts down while running without mutating the input", () => {
    ...
    expect(running.remaining).toBe(POMODORO_FOCUS_SECONDS); // immutable
  });

  it("flips focus → break and increments completed rounds at zero", () => {
  ...
  it("flips break → focus without incrementing rounds", () => {
