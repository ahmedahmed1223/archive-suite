...
export default function DiscoverPage() {
  ...
  const ActiveIcon = SECTION_ICONS[activeSection?.id] || Compass;
  ...
  return (
    <MotionPage className="space-y-5 p-4 sm:p-6">
      ...
      <section className="space-y-4" aria-labelledby="discover-sections-title">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className={`badge badge-soft ${TONE_BADGES[activeSection.tone] || "badge-neutral"}`}>
