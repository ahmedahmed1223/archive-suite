export const PAGE_MANIFEST = [
  ...
  { id: "kanban", group: "daily", heavy: false, meta: { title: "لوحة الحالة", breadcrumb: "الرئيسية / لوحة الحالة", hint: "عناصر الأرشيف موزّعة على أعمدة حسب حالة سير العمل مع نقل سريع بين الحالات.", helpSection: "dashboard-archive" } },
  ...
  { id: "system-control", group: "maintenance", heavy: false, meta: { title: "مركز تحكم النظام", breadcrumb: "الصيانة / مركز التحكم", hint: "مراقبة حالة النظام والموارد (المعالج/الذاكرة/القرص) والخدمات للقراءة فقط — أزرار التحكم بالخدمات مؤجَّلة لأنها تتطلب صلاحيات النظام.", helpSection: "transfer-export" } },
