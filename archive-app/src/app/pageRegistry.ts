...
const SettingsHubPage     = lazy(() => import("../pages/SettingsHubPage.jsx").then((m) => ({ default: m.SettingsHubPage as ComponentType<any> })));
...
type LazyPageComponent = LazyExoticComponent<ComponentType<any>>;

const SplitViewPage          = lazy(() => import("../components/layout/SplitView.jsx").then((m) => ({ default: m.SplitView as ComponentType<any> })));
const SharedLinksPage        = lazy(() => import("../pages/SharedLinksPage.jsx"));
const SharedWithMePage       = lazy(() => import("../pages/SharedWithMePage.jsx"));

export const PAGE_COMPONENTS: Record<string, LazyPageComponent> = {
