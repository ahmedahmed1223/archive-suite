...
function matchesFilters(item: any, filters: any) {
  ...
  if (filters.tags && filters.tags.length > 0) {
    ...
    const hasTag = filters.tagMode === "any"
      ? filters.tags.some((t: any) => itemTags.includes(t))
      : filters.tags.every((t: any) => itemTags.includes(t));
...
export function SmartSelectionBuilder({ onApply, onClose }: any) {
  ...
  const update = (patch: any) => setFilters((f: any) => ({ ...f, ...patch }));

  const matchingIds = React.useMemo(
    () => videoItems.filter((item: any) => matchesFilters(item, filters)).map((item: any) => item.id),
    [videoItems, filters]
  );

  const typesInData = React.useMemo(() => {
    const set = new Set(videoItems.map((i: any) => i.type).filter(Boolean));
    return [...set];
  }, [videoItems]);

  const subtypesInData = React.useMemo(() => {
    if (!filters.type) return [];
    const set = new Set(videoItems.filter((i: any) => i.type === filters.type).map((i: any) => i.subtype).filter(Boolean));
    return [...set];
              ...
              children: [
                jsxs("div", {
                  children: [
                    ...
                    jsxs("select", {
                      value: filters.type,
                      onChange: (e: any) => update({ type: e.target.value, subtype: "" }),
                      ...
                      children: [
                        ...
                        typesInData.map((t: any) => jsx("option", { value: t, children: t }, t))
                      ]
                    })
                  ]
                }),
                jsxs("div", {
                  children: [
                    ...
                    jsxs("select", {
                      ...
                      onChange: (e: any) => update({ subtype: e.target.value }),
                      ...
                      children: [
                        ...
                        subtypesInData.map((s: any) => jsx("option", { value: s, children: s }, s))
                      ]
                    })
                  ]
                })
                ...
                jsxs("div", {
                  children: [
                    ...
                    jsx("input", {
                      ...
                      onChange: (e: any) => update({ dateFrom: e.target.value }),
                      className: "w-full rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-gray-100 focus:outline-none focus:border-blue-500"
                    })
                  ]
                }),
                jsxs("div", {
                  children: [
                    ...
                    jsx("input", {
                      ...
                      onChange: (e: any) => update({ dateTo: e.target.value }),
                      className: "w-full rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-gray-100 focus:outline-none focus:border-blue-500"
                    })
                  ]
                })
            ...
            jsxs("div", {
              children: [
                ...
                jsxs("div", {
                  ...
                  children: SIZE_OPTIONS.map((opt: any, i: any) =>
                    jsx("button", {
                      type: "button",
            ...
            jsxs("div", {
              children: [
                ...
                jsxs("div", {
                  ...
                  children: [
                    jsx("input", {
                      ...
                      onChange: (e: any) => update({ tagInput: e.target.value }),
                ...
                filters.tags.length > 0 && jsx("div", {
                  ...
                  children: filters.tags.map((tag: any) =>
                    jsxs("span", {
                      ...
                      children: [
                        ...
                        jsx("button", {
                          type: "button",
                          onClick: () => update({ tags: filters.tags.filter((t: any) => t !== tag) }),
