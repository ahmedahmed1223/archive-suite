...
function TagPill({ tag, onRemove }: any) {
  return jsxs("span", {
...
export function QuickCaptureWidget({
  ...
  useEffect(() => {
    if (autoFocus) (titleRef.current as any)?.focus();
  }, [autoFocus]);
  ...
  const handleTagKeyDown = useCallback(
    (e: any) => {
      if (e.key === "Enter" || e.key === "," || e.key === " ") {
        ...
        setTags((prev: any) => prev.slice(0, -1));
      }
    },
            ...
            children: [
              ...
              jsxs("div", {
                ...
                children: [
                  ...
                  tags.map((t: any) => jsx(TagPill, { tag: t, onRemove: removeTag }, t)),
                  jsx("input", {
                    type: "text",
                    value: tagInput,
