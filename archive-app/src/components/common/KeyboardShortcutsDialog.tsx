...
export function KeyboardShortcutsDialog({ open, onOpenChange }: any) {
  ...
  const updateShortcutQuery = (value: any) => {
      ...
      children: [
          ...
          children: [
            ...
            jsxs("div", {
              ...
              children: [
                ...
                jsx("input", {
                  value: shortcutQuery,
                  onChange: (event: any) => updateShortcutQuery(event.target.value),
        ...
        jsx("div", {
          ...
          children: categories.length === 0 ? jsx("p", {
            ...
            className: "space-y-4",
            children: categories.map((category: any) => jsxs("section", {
              children: [
                jsx("h3", { className: "mb-2 text-sm font-medium va-accent-text", children: category }),
                jsx("div", {
                  className: "space-y-1",
                  role: "list",
                  children: getShortcutDialogItemsForCategory(SHORTCUT_ACTIONS, visibleShortcuts, category).map((shortcut: any) => {
