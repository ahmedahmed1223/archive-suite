 ...
 */
export function StarRating({ value = 0, onChange, readonly = false, size = "md" }: any) {
  ...
  if (readonly) {
    return jsxs("span", {
      ...
      children: [1, 2, 3, 4, 5].map((star: any) => jsx("span", {
        "aria-hidden": "true",
  ...
  return jsxs("div", {
    ...
    children: [1, 2, 3, 4, 5].map((star: any) => jsx("button", {
      type: "button",
