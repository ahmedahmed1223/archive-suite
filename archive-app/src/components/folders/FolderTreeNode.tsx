 ...
 */
export function FolderTreeNode({ folder, tree, depth = 0, selectedId, onSelect, onToggle, onContextMenu, onDrop, countEntityType = "archive-item" }: any) {
  ...
  return (
    <li role="none">
      <DropZone
        as="div"
        onDrop={onDrop ? (ids: any) => onDrop(folder.id, ids) : undefined}
        disabled={!onDrop}
