...
export function SubtitleRenderer({ cues, currentTime, size = "md", color = "#ffffff", enabled = true }: any) {
  ...
  return (
    ...
    >
      <p
        className={`max-w-[90%] whitespace-pre-wrap rounded-md bg-black/60 px-3 py-1.5 text-center font-semibold leading-snug shadow-lg ${(SIZE_CLASS as any)[size] || SIZE_CLASS.md}`}
        dir="auto"
