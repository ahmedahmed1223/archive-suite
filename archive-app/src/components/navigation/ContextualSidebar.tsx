...
function iconForAction(action: any) {
  return (ACTION_ICONS as any)[action.id] || (ACTION_ICONS as any)[action.targetPage] || ArrowRight;
}
 ...
 * }} props
 */
export function ContextualQuickActions({ currentPage, onNavigate, collapsed = false }: any) {
