...
function readImageAsDataUrl(file: any) {
...
export function IconPicker({
  ...
  const applySpec = (spec: any, nextFallbackIcon: any = fallbackIcon) => {
  ...
  const visibleBuiltinIcons = APP_ICON_REGISTRY.filter((item: any) => {
  ...
  return jsxs("div", {
    ...
    children: [
      ...
      jsx("div", {
        ...
        children: tabs.map((tab: any) => jsx("button", {
          type: "button",
          role: "tab",
      ...
      activeTab === "builtin" && jsxs("div", {
        ...
        children: [
          ...
          jsx("div", {
            ...
            children: visibleBuiltinIcons.map((item: any) => {
      ...
      activeTab === "emoji" && jsxs("div", {
        ...
        children: [
          jsx("div", {
            ...
            children: ICON_PICKER_EMOJIS.map((icon: any) => jsx("button", {
              type: "button",
              onClick: () => {
                setTextValue(icon);
          ...
          jsxs("div", {
            ...
            children: [
              jsx("input", {
                value: textValue,
                onChange: (event: any) => setTextValue(event.target.value.slice(0, 8)),
