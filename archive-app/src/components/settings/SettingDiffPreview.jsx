 ...
 */
export function SettingDiffPreview({ diffs = [], onConfirm, onCancel }) {
  if (!diffs.length) {
    return jsxs("div", {
  ...
  const hasRestartRequired = diffs.some((d) => d.entry.restartRequired);
    ...
    children: [
      ...
      jsx("div", {
        ...
        children: jsx("table", {
          ...
          children: jsxs("tbody", {
            children: diffs.map(({ entry, currentValue, nextValue }, idx) => (
              jsxs("tr", {
                ...
                children: [
                  jsxs("td", {
                    ...
                    children: [
                      ...
                      jsx("span", { className: "block text-[11px] text-gray-500", children: SETTINGS_CATEGORY_LABELS[entry.category] || entry.category }),
                    ],
                  }),
                  jsx("td", {
