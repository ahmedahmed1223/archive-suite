 ...
 */
export function SettingsSearch({ onSelectEntry, autoFocus = false }: any) {
  ...
  useEffect(() => {
    if (autoFocus) (inputRef.current as any)?.focus();
  }, [autoFocus]);
      ...
      children: [
        ...
        showResults && jsx("div", {
          ...
          children: jsx("ul", {
            ...
            children: results.slice(0, 12).map((entry: any) => (
              jsxs("li", {
                children: [
                  jsxs("button", {
                    type: "button",
                    ...
                    children: [
                      ...
                      jsxs("span", {
                        ...
                        children: [
                          (SETTINGS_CATEGORY_LABELS as any)[entry.category] || entry.category,
