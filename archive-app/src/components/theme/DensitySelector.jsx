...
// Preview illustration for each density variant — simple row-spacing mockup.
 ...
 *
 * @param {{ density: string, onChange: (id: string) => void }} props
 */
export function DensitySelector({ density, onChange }) {
  return (
