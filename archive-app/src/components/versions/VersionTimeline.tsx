 ...
 * }} props
 */
export function VersionTimeline({ versions = [], selectedVersion, onSelect, onRestore, currentVersion }: any) {
  if (!versions.length) {
    return jsxs("div", {
  ...
  return jsxs("div", {
    ...
    children: [
      ...
      jsx("ol", {
        ...
        children: versions.map((v: any, idx: any) => {
                  ...
                  jsxs("span", {
                    ...
                    children: [
                      ...
                      onRestore && !isCurrent && jsx("span", {
                        onClick: (e: any) => { e.stopPropagation(); onRestore(v); },
