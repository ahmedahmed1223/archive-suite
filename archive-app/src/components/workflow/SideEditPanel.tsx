 ...
 */
export function SideEditPanel({ item, contentTypes = [], onSave, onClose }: any) {
                  ...
                  children: [
                    jsxs("div", {
                      ...
                      children: [
                        ...
                        jsx("input", {
                          ...
                          type: "text",
                          value: title,
                          onChange: (e: any) => { setTitle(e.target.value); markDirty(); },
                    ...
                    contentTypes.length > 0 && jsxs("div", {
                      ...
                      children: [
                        ...
                        jsx("select", {
                          id: "sep-type",
                          value: typeId,
                          onChange: (e: any) => { setTypeId(e.target.value); markDirty(); },
                          ...
                          children: contentTypes
                            .filter((ct: any) => ct.status !== "archived")
                            .map((ct: any) => jsx("option", { value: ct.id, children: ct.name || ct.id }, ct.id))
                        })
                      ]
                    }),
                    ...
                    jsxs("div", {
                      ...
                      children: [
                        ...
                        jsx(TagAutocomplete, {
                          value: tagsText,
                          onChange: (v: any) => { setTagsText(v); markDirty(); },
                          suggestions: allTags,
                    ...
                    jsxs("div", {
                      ...
                      children: [
                        ...
                        jsx("textarea", {
                          id: "sep-notes",
                          value: notes,
                          onChange: (e: any) => { setNotes(e.target.value); markDirty(); },
                          rows: 4,
