...
function CompactStat({ label, value, hint }: any) {
  return jsxs("span", {
...
function MobileControlButton({ children, onClick, active = false, danger = false, icon }: any) {
  return jsxs("button", {
    type: "button",
    onClick,
    "aria-pressed": active,
 ...
 */
function GridDensitySlider({ gridColumns, gridColumnCount, onChange }: any) {
 ...
 * ArchivePage.jsx.
 */
export function ArchivePageHero(props: any) {
  const {
    activeTopMode,
    activeViewMode,
    activeItemSize,
  ...
  const currentViewLabel = VIEW_MODE_BUTTONS.find((button: any) => button.id === activeViewMode)?.label || "شبكة";
  ...
  const handleSortChange = ({ sortField: nextField, sortDirection: nextDirection }: any) => {
    setSortField(nextField);
    setSortDirection(nextDirection);
  };

  const toggleBulkMode = () => {
    setBulkMode((value: any) => {
  ...
  const topModeControl = ({ mobile = false }: any = {}) => jsxs("div", {
  ...
  const viewModeControl = ({ mobile = false }: any = {}) => jsx("div", {
    ...
    children: VIEW_MODE_BUTTONS.map(({ id, label, Icon }: any) => jsxs("button", {
      type: "button",
      ...
      jsxs("label", {
        ...
        children: [
          ...
          jsxs("select", {
            ...
            children: ARCHIVE_PAGE_SIZE_OPTIONS.map((option: any) => jsx("option", { value: option, children: formatNumber(option) }, option))
          })
        ]
      })
    ]
          ...
          jsxs("div", {
            ...
            children: [
              ...
              showDeleted && confirmEmptyTrash && jsxs("button", {
                type: "button",
                onClick: () => {
                  const deletedCount = videoItems.filter((item: any) => item.isDeleted).length;
      ...
      quickSearchMatches.length > 0 && jsxs("div", {
        ...
        children: [
          ...
          jsx("div", {
            ...
            children: quickSearchMatches.map((item: any) => jsxs("button", {
              type: "button",
              onClick: () => {
                setPage(1);
          ...
          jsxs("section", {
            ...
            children: [
              ...
              jsxs("div", {
                ...
                children: [
                  jsx(MobileControlButton, { active: showFavoritesOnly, onClick: () => setShowFavoritesOnly((value: any) => !value), icon: jsx(Tags, { className: "h-4 w-4" }), children: "المفضلة" }),
                  jsx(MobileControlButton, { active: showDeleted, danger: showDeleted, onClick: () => setShowDeleted((value: any) => !value), icon: jsx(Trash2, { className: "h-4 w-4" }), children: "المحذوفات" }),
                  jsx(MobileControlButton, { active: showGapsOnly, onClick: () => setShowGapsOnly?.((value: any) => !value), icon: jsx(TriangleAlert, { className: "h-4 w-4" }), children: "بحاجة لتوصيف" }),
