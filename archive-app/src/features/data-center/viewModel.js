...
export function getNextBackupTime(schedule = "manual", lastBackupAt = null, now = Date.now()) {
  const intervalMs = BACKUP_INTERVALS_MS[schedule];
...
export function formatTimeUntilBackup(nextBackupTime, now = Date.now()) {
