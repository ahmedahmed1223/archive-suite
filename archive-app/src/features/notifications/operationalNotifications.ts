export function createConnectionStatusNotification(previous: any = null, next: any = {}): any {
...
export function shouldEmitOperationalNotification(notice: any, memory: Record<string, number> = {}, now = Date.now(), cooldownMs = 60_000): boolean {
