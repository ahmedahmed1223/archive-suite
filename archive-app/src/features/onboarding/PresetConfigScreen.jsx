...
function StatusRow({ label, value, ok, placeholder }) {
  return jsxs("div", {
 ...
 */
export function PresetConfigScreen({ config, onUsePreset, onManualSetup }) {
  const backendLabel = BACKEND_LABELS[config?.backend] || config?.backend || "—";
