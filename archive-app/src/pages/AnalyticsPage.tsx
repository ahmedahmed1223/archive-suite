...
function GrowthChart({ growth }: any) {
  return (
...
function ListPanel({ title, icon, children }: any) {
  return (
...
function filterByRange(items: any, rangeId: any) {
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            >
              {uncategorized.count === 0 ? (
                ...
                <div className="space-y-2">
                  {uncategorized.items.slice(0, 50).map((item: any) => (
                    <button
                      key={item.id}
                      type="button"
          ...
          >
            {duplicates.length === 0 ? (
              ...
              <div className="space-y-3">
                {duplicates.slice(0, 20).map((group: any) => (
                  <div
                    key={group.key}
