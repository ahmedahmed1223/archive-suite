...
function HelpPanel({ title, children, icon = null, className = "" }: any) {
  return jsxs("section", {
...
function HelpText({ children }: any) {
  return jsx("p", {
...
function helpChipButtonClass(isActive: any) {
...
function InfoGrid({ items }: any) {
  return jsx("div", {
    ...
    children: items.map(([title, description]: any) => jsxs("div", {
...
function NumberedList({ items }: any) {
  return jsx("ol", {
    className: "va-rtl-list va-numbered-list va-body va-muted space-y-2",
    children: items.map((item: any) => jsx("li", { children: item }, item))
  });
}
...
function createHelpSections(keyboardShortcuts: any, { roleProfile, onRoleProfileChange, onOpenPage }: any = {}) {
  return [
    {
      id: "guided-journey",
      ...
      content: jsxs(Fragment, {
        children: [
          ...
          jsx("div", {
            ...
            children: keyboardShortcuts.map((shortcut: any) => jsxs("div", {
              ...
              children: [
                ...
                jsx("div", {
                  ...
                  dir: "ltr",
                  children: shortcut.keys.map((key: any, index: any) => jsxs("span", {
                    children: [
                      jsx("kbd", {
...
export function HelpPage() {
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: any) => {
      ...
      (searchInputRef.current as any)?.select?.();
    };
  ...
  const onRoleProfileChange = React.useCallback((value: any) => {
    updateSettings({ ui: { ...(settings.ui || {}), roleProfile: normalizeRoleProfileId(value) } });
  }, [settings.ui, updateSettings]);
  const openRolePage = React.useCallback((page: any) => {
    setCurrentPage?.(page);
  }, [setCurrentPage]);
  ...
  const scrollToSection = React.useCallback((sectionId: any, options: any = {}) => {
        ...
        children: jsxs("div", {
          ...
          children: [
            ...
            jsxs("nav", {
              ...
              children: [
                filteredSections.map((section: any) => jsxs("button", {
                  type: "button",
        ...
        children: [
            ...
            children: jsxs("div", {
              ...
              children: [
                    ...
                    jsxs("div", {
                      ...
                      children: [
                        ...
                        jsx("input", {
                          ref: searchInputRef,
                          value: helpQuery,
                          onChange: (event: any) => setHelpQuery(event.target.value),
                ...
                jsx("div", {
                  ...
                  children: HELP_QUICK_SECTION_LINKS.map(([sectionId, label]: any) => jsx("button", {
                    type: "button",
          ...
          jsx("div", {
            ...
            children: jsx("div", {
              ...
              children: jsx("div", {
                className: "flex flex-wrap gap-2",
                children: filteredSections.map((section: any) => jsxs("button", {
                  type: "button",
                  onClick: () => scrollToSection(section.id),
            ...
            children: jsxs(Fragment, {
              children: [
                ...
                visibleContextCards.length === 0 ? jsx("p", {
                  ...
                  children: visibleContextCards.map((card: any) => jsxs("button", {
                    type: "button",
          ...
          jsx("div", {
            ...
            children: jsxs("div", {
              ...
              children: [
                ...
                filteredSections.map((section: any) => jsx("div", {
                ...
                jsx("div", {
                  ...
                  children: jsx(HelpPanel, {
                    ...
                    children: jsx("div", {
                      ...
                      }) : filteredFaqItems.map((faq: any, index: any) => jsxs("div", {
                ...
                jsx("div", {
                  ...
                  children: jsxs("button", {
                    type: "button",
                    onClick: () => (contentRef.current as any)?.scrollTo({ top: 0, behavior: "smooth" }),
