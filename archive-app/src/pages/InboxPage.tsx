...
function InboxItemCard({ item, onArchive, onDismiss }: any) {
  return jsxs("div", {
    className:
...
export default function InboxPage() {
  const inboxItems = useAppStore((s: any) => s.inboxItems);
  const inboxLoading = useAppStore((s: any) => s.inboxLoading);
  const inboxSort = useAppStore((s: any) => s.inboxSort);
  const loadInboxFromStorage = useAppStore((s: any) => s.loadInboxFromStorage);
  const captureInboxItem = useAppStore((s: any) => s.captureInboxItem);
  const archiveInboxItem = useAppStore((s: any) => s.archiveInboxItem);
  const dismissInboxItem = useAppStore((s: any) => s.dismissInboxItem);
  const archiveAllInboxItems = useAppStore((s: any) => s.archiveAllInboxItems);
  const setInboxSort = useAppStore((s: any) => s.setInboxSort);
  const showNotification = useAppStore((s: any) => s.showNotification);
  const addVideoItem = useAppStore((s: any) => s.addVideoItem);
    ...
    children: [
          ...
          children: [
            ...
            jsxs("div", {
              ...
              children: [
                ...
                jsx("select", {
                  value: inboxSort,
                  onChange: (e: any) => setInboxSort(e.target.value),
                  ...
                  children: SORT_OPTIONS.map(({ value, label }: any) =>
      ...
      inboxLoading && !hasItems
        ...
        : jsx("div", {
            ...
            children: inboxItems.map((item: any) =>
              jsx("div", {
                role: "listitem",
