...
function FilterChips({ filters = {} }: any) {
  const chips = Object.entries(filters)
    .filter(([, v]: any) => v !== undefined && v !== null && v !== "" && !(Array.isArray(v) && v.length === 0))
    .map(([k, v]: any) => `${k}: ${Array.isArray(v) ? v.join(", ") : v}`);

  if (chips.length === 0) return null;
  return jsxs("div", {
    className: "mt-1.5 flex flex-wrap gap-1",
    children: chips.map((chip: any) =>
      jsx("span", {
...
function SearchCard({ search, onRun, onDelete, onToggleAlert }: any) {
...
export default function SavedSearchesPage() {
  ...
  const visible = React.useMemo(() => {
    if (filter === "alerts") return savedSearches.filter((s: any) => s.alertEnabled);
  ...
  return jsxs("div", {
    ...
    children: [
        ...
        children: [
          ...
          jsx("button", {
            ...
            children: [
              ...
              `التنبيهات (${savedSearches.filter((s: any) => s.alertEnabled).length})`
            ]
          })
        ]
      }),
      ...
      savedSearchesLoading && jsx("div", {
        className: "space-y-3",
        children: [0, 1, 2].map((i: any) => jsx(SkeletonCard, {}, i))
      }),
      ...
      !savedSearchesLoading && visible.length > 0 && jsx("div", {
        className: "space-y-3",
        children: visible.map((search: any) =>
          jsx(SearchCard, {
            search,
            onRun: handleRun,
