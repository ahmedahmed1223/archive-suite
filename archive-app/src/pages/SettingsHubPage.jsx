                    ...
                    jsxs("span", {
                      ...
                      children: [
                        jsxs("span", {
                          ...
                          children: [
                            jsx("span", { className: "font-semibold text-[var(--va-text)]", children: SETTINGS_CATEGORY_LABELS[cat] || cat }),
                        ...
                        jsx("span", { className: "mt-1 block text-xs leading-5 text-[var(--va-text-2)]", children: CATEGORY_DESCRIPTIONS[cat] || "" }),
