...
import {
  automationActionKeys,
  automationInitialState,
  createAutomationActions
} from "./slices/automationSlice.js";
import {
  createSummaryActions,
  summaryActionKeys,
  summaryInitialState
} from "./slices/summarySlice.js";
import {
  createUserActions,
  userActionKeys,
  userInitialState
...
export { automationActionKeys } from "./slices/automationSlice.js";
export { summaryActionKeys } from "./slices/summarySlice.js";
export { userActionKeys } from "./slices/userSlice.js";
export { historyActionKeys } from "./slices/historySlice.js";

export let useAuthStore: any;
export let useSessionStore: any;

export const useAppStore: any = createStore((set, get) => ({
  ...archiveInitialState,
  ...userInitialState,
  ...historyInitialState,
  ...settingsInitialState,
  ...
  ...createUserActions({ set, get, getAuthStore: () => useAuthStore }),
  ...createHistoryActions({ set, get })
}));

useAuthStore = createAuthStore({ createStore, useAppStore });
useSessionStore = createSessionStore({ createStore });
