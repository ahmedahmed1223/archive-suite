...
هذه الحزمة هي الواجهة الخلفية للبنية المعتمدة المبنية على Laravel وNext.js.
تملك سلوك API والتخزين والتفويض وطوابير المهام والخدمات الفورية وسجل التدقيق.
الواجهة المعتمدة هي `archive-next`، والعقد العام المشترك هو
