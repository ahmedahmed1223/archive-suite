# Masar Laravel backend

[العربية](README.ar.md) · [Documentation](../docs/README.md)

This package owns Masar's API behaviour, persistence, authorisation, queues,
realtime services, and audit trail. The canonical frontend is `archive-next`;
...
See [API documentation](../docs/api/README.md) and [backend reference](ARCHIVE_MIGRATION.md).
