...
class MediaJobsController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'operation' => ['required', 'string', Rule::in(['thumbnail', 'transcode', 'transcription', 'ocr', 'media_probe', 'media_qc', 'montage_export'])],
            'sourcePath' => [Rule::requiredIf(fn (): bool => in_array($request->input('operation'), ['media_probe', 'media_qc'], true)), 'nullable', 'string', 'max:2048', $safePathRule],
