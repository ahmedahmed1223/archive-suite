...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['archive.auth', 'archive.audit'])->post('/collaboration/rooms/{roomKey}/locks', [CollaborationController::class, 'acquireLock']);
    Route::middleware(['archive.auth', 'archive.audit'])->post('/collaboration/rooms/{roomKey}/locks/release', [CollaborationController::class, 'releaseLock']);
    ...
    Route::middleware(['archive.auth', 'archive.audit'])->group(function (): void {
        ...
        Route::post('/metadata-templates/{id}/publish', [MetadataTemplatesController::class, 'publish']);
        ...
        Route::post('/records/{id}/department-handoffs', [DepartmentHandoffController::class, 'store']);
        ...
        Route::get('/vocabulary/{id}/relink-preview', [VocabularyRelinkController::class, 'preview']);
        Route::post('/vocabulary/{id}/relink', [VocabularyRelinkController::class, 'relink']);
        ...
        Route::get('/field-requests', [RecordFieldRequestController::class, 'open']);
        Route::get('/records/{id}/field-requests', [RecordFieldRequestController::class, 'index']);
        ...
        Route::get('/vocabulary/kinds', [VocabularyController::class, 'kinds']);
        Route::put('/vocabulary/kinds', [VocabularyController::class, 'replaceKinds']);
