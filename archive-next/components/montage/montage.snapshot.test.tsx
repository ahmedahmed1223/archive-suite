...
const editorCopy = {
  ...
  previewCmx: "Preview CMX interchange",
  interchangeTitle: "CMX interchange",
  previewOnlyHint: "Preview only — nothing is applied yet",
  previewAccepted: "Accepted",
  previewRejected: "Rejected",
  previewFailed: "Could not preview the interchange",
  reelMapping: "Reel mapping",
  applyCmx: "Apply mapped revisions",
  applyCmxFailed: "Could not apply the interchange",
