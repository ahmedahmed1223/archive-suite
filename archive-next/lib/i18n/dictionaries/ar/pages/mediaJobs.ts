export const mediaJobs = {
  ...
  workflow: {
    ...
    retryAction: "إعادة تشغيل المهمة",
    retryFailed: "تعذّر إدراج إعادة التشغيل.",
    retryGuidanceDescription: "عالِج السبب ثم أعد إدراج المدخلات نفسها. تبقى المحاولة الفاشلة وسببها مسجّلين.",
