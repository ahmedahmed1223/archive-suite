export const mediaReview = {
  ...
  media: {
    ...
    contextLabel: "معرّف المادة للمراجعة",
    contextDescription: "يوفر رابط المراجعة هذا المعرّف ويظل ثابتًا أثناء العمل.",
    missingContextTitle: "اختر مادة للمراجعة المرئية",
    missingContextDescription: "افتح رابط مراجعة يتضمن معرّف المادة. وإلى أن يدعم الخادم ربط السجل بجلسة المراجعة، اختر السجل من الأرشيف أو افتح استديو الوسائط الخاص به.",
    openArchive: "استعراض الأرشيف",
    openStudio: "فتح استديو الوسائط",
