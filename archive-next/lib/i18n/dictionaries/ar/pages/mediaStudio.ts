export const mediaStudio = {
  ...
  advancedPanels: {
    label: "الإصدارات والخط الزمني والمهام"
  },
  readiness: {
    title: "جاهزية المادة",
  ...
  montageEditor: {
    ...
    binAriaLabel: "مخزن المواد",
    drawerAriaLabel: "درج التصدير",
    ...
    presenceLabel: "محررون آخرون مفتوحون",
    noOtherEditors: "لا يوجد محرر آخر",
    previewCmx: "معاينة قائمة CMX 3600",
    interchangeTitle: "معاينة تبادل المونتاج",
    previewOnlyHint: "هذه معاينة فقط ولا تغيّر المشروع.",
