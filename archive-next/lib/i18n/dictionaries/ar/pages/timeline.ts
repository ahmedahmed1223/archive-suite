export const timeline = {
  ...
  day: "يوم", month: "شهر", year: "سنة", refresh: "تحديث", granularity: "دقة التجميع", loading: "جارٍ تحميل السجلات", loadingDescription: "يتم جلب السجلات من الخادم وتجهيزها للعرض الزمني.", loadError: "تعذر تحميل الخط الزمني", unknownError: "خطأ غير معروف", loadFailed: "فشل تحميل السجلات: {message}",
