export const mediaReview = {
  ...
  media: {
    ...
    contextLabel: "Review media identifier",
    contextDescription: "The identifier is supplied by the review link and is kept fixed while you work.",
    missingContextTitle: "Select media for visual review",
    missingContextDescription: "Open a review link that includes a media identifier. Until a server-supported record-to-review link exists, use the archive to choose a record or open its media studio.",
    openArchive: "Browse archive",
    openStudio: "Open media studio",
