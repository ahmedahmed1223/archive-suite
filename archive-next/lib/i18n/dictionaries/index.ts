...
const arabicDictionary = { auth: arAuth, help: arHelp, settings: arSettings, shared: arShared, shell: arShell } as const;

export type AppDictionary = DictionaryShape<typeof arabicDictionary>;

export const dictionaries = {
  ar: arabicDictionary,
  en: { auth: enAuth, help: enHelp, settings: enSettings, shared: enShared, shell: enShell },
