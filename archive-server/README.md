...
[`@archive/core`](https://github.com/ahmedahmed1223/archive-core) (عبر وسم git)
وتضيف محوّلات السحابة وخادم PocketBase وحاويات Docker.
...
BACKEND=postgres npm start          # يشغّل عبر tsx (Prisma 7 يولّد TypeScript)
...
```bash
npm install            # @archive/core + pocketbase SDK + @prisma/client
npm run verify         # 27 اختبار (13 PocketBase + 14 Postgres)، Node بلا خوادم حيّة
```
...
مثبّت بوسم: `"@archive/core": "github:ahmedahmed1223/archive-core#v1.1.0"`.
الترقية = رفع الوسم بوعي.
