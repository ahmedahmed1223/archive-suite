 ...
 */
export const AI_PROVIDERS: Readonly<Record<string, ProviderConfig>> = Object.freeze({
  openrouter: {
 ...
 */
export function listAiProviders(): ProviderOption[] {
 ...
 */
export function resolveAiProvider(id: string, overrides: { baseUrl?: string; model?: string } = {}): ResolvedProvider {
