...
[English](arabic-ui-glossary.md) · [فهرس التوثيق](README.ar.md)
...
| Direct-host operation (Native) | التشغيل المباشر دون حاويات (Native) | استخدم «التشغيل المباشر» بعد الذكر الأول. |
| Access token | رمز وصول | لا تستخدم الرمز الخام في الأمثلة. |
| Secret store | مخزن أسرار | موضع محمي لحفظ بيانات الاعتماد. |
