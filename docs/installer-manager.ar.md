...
يعرض المعالج داخل الطرفية نصوصًا إنجليزية وقوائم مرقمة، ويتحقق من الردود قبل المتابعة. تظهر الألوان في الطرفيات التفاعلية فقط، ويمكن تعطيلها بضبط `NO_COLOR=1`. يفحص المعالج معمارية x64 والذاكرة ومساحة القرص والصلاحيات وتوفر Docker. يفحص منافذ طريقة التشغيل المختارة قبل التثبيت. الحد المطلوب للملف الأساسي 8 GiB من الذاكرة و100 GiB من المساحة الحرة، وفق عقد دعم المنتج.
