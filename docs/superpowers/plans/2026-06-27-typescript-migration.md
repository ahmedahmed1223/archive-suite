...
- [ ] **Step 1: Add TypeScript as a workspace dev dependency**
...
- [ ] **Step 3: Convert or preserve tests**
...
- [ ] **Step 1: Keep TypeScript module resolution compatible with Vite and Next.js**
...
- [ ] **Step 2: Do not convert the React root before the Next.js shell**
...
- [ ] **Step 3: Keep framework-specific typings isolated**
...
- [ ] **Step 1: Track converted surface area**
