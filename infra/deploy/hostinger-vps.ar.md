...
[English](hostinger-vps.md) · [فهرس التوثيق](../../docs/README.ar.md)

ينشر هذا الدليل الحزمة المعتمدة **Laravel + Next.js** من
...
ينشئ Control Center `infra/.env` من النموذج المعتمد، ويستبدل الأسرار الافتراضية
...
اضبط سجل DNS قبل النشر العام. يدير Caddy الشهادة من الحزمة المعتمدة تلقائيًا
