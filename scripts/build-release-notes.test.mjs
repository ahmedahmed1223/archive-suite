...
test("builds an Arabic-first GitHub Release body with a collapsible English section", () => {
  ...
  try {
    ...
    assert.match(notes, /\[English release notes\]\(https:\/\/github\.com\/ahmedahmed1223\/archive-suite\/blob\/v1\.2\.0\/docs\/release-notes\/v1\.2\.0\.md\)/);
    assert.match(notes, /https:\/\/github\.com\/ahmedahmed1223\/archive-suite\/blob\/v1\.2\.0\/docs\/release-notes\/v1\.2\.0\.md/);
    assert.match(notes, /https:\/\/github\.com\/ahmedahmed1223\/archive-suite\/blob\/v1\.2\.0\/docs\/README\.ar\.md/);
