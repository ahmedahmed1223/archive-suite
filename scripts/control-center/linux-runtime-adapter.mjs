...
export const LINUX_INSTALL_STEPS = ["data-services-ready", "ownership-applied", "logrotate-applied", "app-configured", "database-migrated", "firewall-applied", "services-installed", "services-started"];

export function createLinuxNativeRuntimeAdapter({ services = LINUX_SERVICES, serviceControl, applyOwnership, applyLogrotate, writeAppConfig, migrateDatabase, applyFirewallRules, ...rest } = {}) {
