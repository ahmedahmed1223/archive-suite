...
function stageFixture(root) {
  ...
  stageWindowsDataServices({ destDir: dataServicesPath, postgresInstaller: installer, pgvectorDirectory: pgvector });
  return dataServicesPath;
}

test("Windows data package reader returns only verified bundle-relative PostgreSQL and pgvector paths", () => {
