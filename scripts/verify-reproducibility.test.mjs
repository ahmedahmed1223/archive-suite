...
test("root frozen install and reproducibility verification are canonical gates", () => {
  ...
  assert.equal(rootPackage.scripts["verify:reproducibility"], "node --test scripts/verify-reproducibility.test.mjs scripts/verify-immutable-images.test.mjs scripts/verify-release-supply-chain.test.mjs scripts/release-license-policy.test.mjs");
